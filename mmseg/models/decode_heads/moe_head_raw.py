...
if __name__ == '__main__':
    #[64, 128, 256, 512]
    input_1 = torch.randn((1,64,256,256,))
    input_2 = torch.randn((1, 128, 128, 128,))
    input_3 = torch.randn((1, 256, 64, 64,))
    input_4 = torch.randn((1, 512, 32, 32,))
    print(input_1.shape)
    print(input_2.shape)
    print(input_3.shape)
    print(input_4.shape)
    decode = MOEHead(prescale_mlp_dims=[256, 256], # new
