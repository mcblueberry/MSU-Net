...
class MOEHead(BaseDecodeHead):
    ...
    def __init__(self, feature_strides, prescale_mlp_dims=None, prescale_mlp_final_act=True,
                 ...
                 moe_conv_dims=None, activation='relu', use_linear_fuse=True, **kwargs):
        ...
        for i in range(0,3):
            down_chan=Down_channel(self.in_channel[i])
            self.down_chan.append(down_chan)
    ...
    def forward(self, inputs, img_metas=None):
        ...
        for i, x_i in enumerate(x):
            ...
            if x_i.shape[-2:] != largest_size:
                ...
                x_i_scaled=self.down_chan[i-1](x_i_scaled)
            else:
                x_i_scaled = x_i
...
if __name__ == '__main__':
    ...
    input_4 = torch.randn((1, 1546, 7, 7,))
    print(input_1.shape)
    print(input_2.shape)
    print(input_3.shape)
    print(input_4.shape)
